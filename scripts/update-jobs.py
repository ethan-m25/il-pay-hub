#!/usr/bin/env python3
"""
il-pay-hub/scripts/update-jobs.py
Daily job data updater — Illinois Pay Hub edition.

Reads raw JSONL files from ~/.openclaw/shared/il-jobs-raw-*.txt,
...
def classify_job(job: dict) -> dict:
    ...
    job["_width"] = width
    job["_compliant"] = True   # IL EPEA — 15+ employee postings must comply
...
def main():
    ...
    db["meta"] = {
        ...
        "updated": TIMESTAMP,
        "state": "Illinois",
        "law": "IL Equal Pay Act 820 ILCS 112",
        "currency": "USD",
        "region": "IL",
    }
