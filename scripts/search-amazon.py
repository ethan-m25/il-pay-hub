#!/usr/bin/env python3
"""
il-pay-hub/scripts/search-amazon.py
Amazon Jobs scraper — IL edition.

Strategy: Query amazon.jobs/en/search.json for IL locations.
...
LOG_FILE  = os.path.expanduser("~/il-pay-hub/scripts/amazon.log")
LOCK_FILE = os.path.expanduser("~/il-pay-hub/scripts/.amazon.lock")
...
QUERY_LOCATIONS = ['Chicago, Illinois, USA', 'Virtual Location - Illinois, USA']

REGION_TERMS = ['illinois', 'chicago', 'naperville', 'rockford', 'aurora', 'joliet', 'evanston', ', il']

CITY_MAP = {'chicago': 'Chicago, IL', 'naperville': 'Naperville, IL', 'aurora': 'Aurora, IL'}
...
def main():
    ...
    log("=== Amazon Jobs IL scraper started ===")
    ...
    log(f"=== Amazon IL scraper complete: {total_found} new jobs ===")
    return 0
