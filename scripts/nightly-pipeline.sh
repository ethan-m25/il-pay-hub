...
log "--- healthcheck ---"
python3 "$HOME/shared-scripts/hub_pipeline_healthcheck.py" --hub "il" >> "$LOG_FILE" 2>&1
...
log "--- skill-extract ---"
python3 "$HOME/shared-scripts/hub_skill_extract.py" --hub "il" --limit 30 >> "$LOG_FILE" 2>&1
