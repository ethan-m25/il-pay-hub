#!/usr/bin/env python3
# il-pay-hub/scripts/search-successfactors.py
# IL Equal Pay Act Amendment — salary range required in all postings (eff. Jan 1 2025)

LOG_FILE  = "/Users/clawii/il-pay-hub/scripts/successfactors.log"
LOCK_FILE = "/Users/clawii/il-pay-hub/scripts/.successfactors.lock"
...
SEED_PORTALS = load_successfactors_seeds('il')
REGION_TERMS    = ['chicago', 'naperville', 'schaumburg', 'oak brook', 'deerfield', 'north chicago', 'waukegan', 'libertyville', 'abbott park', 'riverwoods', 'skokie', 'evanston', 'aurora', ', il,', ', il ', 'illinois']
NON_REGION_TERMS = []
CITY_MAP        = {'chicago': 'Chicago, IL', 'naperville': 'Naperville, IL', 'schaumburg': 'Schaumburg, IL', 'oak brook': 'Oak Brook, IL', 'deerfield': 'Deerfield, IL', 'north chicago': 'North Chicago, IL', 'waukegan': 'Waukegan, IL', 'evanston': 'Evanston, IL', 'aurora': 'Aurora, IL'}
DEFAULT_LOCATION = 'Illinois, IL'
SALARY_MIN      = 30000
SALARY_MAX      = 1000000
